...
class ZkSync(Account):
    ...
    async def deposit(
        ...
        logger.info(f"Ip address for 'Bridge to ZkSync' is {self.ip}")
    ...
    async def withdraw(
        ...
        logger.info(f"Ip address for 'Bridge ETH to Ethereum' is {self.ip}")
    ...
    async def wrap_eth(
        ...
        logger.info(f"Ip address for 'Wrap ETH' is {self.ip}")
    ...
    async def unwrap_eth(
        ...
        logger.info(f"Ip address for 'UnWrap ETH' is {self.ip}")
        weth_contract = self.get_contract(ZKSYNC_TOKENS["WETH"], WETH_ABI)
